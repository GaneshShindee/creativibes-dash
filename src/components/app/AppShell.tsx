...
export function AppShell() {
  ...
  return (
    <div className="min-h-screen aurora-bg text-foreground">
      <div className="flex">
        {/* Sidebar */}
        <aside className="hidden lg:flex w-64 shrink-0 flex-col border-r border-border/60 bg-sidebar/60 backdrop-blur-xl min-h-screen sticky top-0">
              ...
              return (
                ...
                >
                  ...
                  {label === "Recommendations" && (
                    <Badge className="ml-auto bg-primary/15 text-primary border-0 text-[10px]">12</Badge>
                  )}
                </Link>
              );
            })}
